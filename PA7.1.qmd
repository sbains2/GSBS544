...
pipeline1_fitted = lr_pipeline1.fit(X_train, y_train)

y_preds = pipeline1_fitted.predict(X_test)

scores1 = cross_val_score(pipeline1_fitted, X, y, cv=5, scoring='r2')
...
scores2 = cross_val_score(pipeline2_fitted, X, y, cv=5, scoring='r2')
...
scores3 = cross_val_score(pipeline3_fitted, X, y, cv=5, scoring='r2')
...
scores4 = cross_val_score(pipeline4_fitted, X, y, cv=5, scoring='r2')

print(mean_squared_error(y_test, y_preds))
print('Our final corss-validated R-squared value is', scores4.mean())
```

Based on the mean squared error, model 1 was the most preferred model.
