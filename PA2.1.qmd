...
# Creating dummy variables for embarked column and joining to original passengers df
passengers.join(pd.get_dummies(passengers['embarked']))
...
# Printing results
print('conditional distribution of class given embarked: ', cd_ce)
print('conditional distribution of embarked given class: ', cd_ec)

# Proportion of 3rd class passengers embarked at Southhampton
prop_third_s = cd_ce.loc['3rd', 'S']
print(prop_third_s)

# Proportion of Southhampton passengers that were in 3rd class
prop_s_third = cd_ec.loc['3rd', 'S']
print(prop_s_third)
```

The proportion of 3rd class passengers that embarked from Southhampton was 54.05%
