...
This script applies four classification models covered in GSB 544 (Linear Discriminant Analysis, Quadratic Discriminant Analysis, Multinomial Logistic Regression, and Support Vector Classification) to the Cards Against Humanity political affiliation data. External (AI) assistance was employed for optimization settings, formatting the confusion matrix plot, extracting the most important predictors, and the code that saves test predictions to a CSV file. 
...
svc_param_grid = {
    # For different values of regularization strength
    'classifier__C': [0.1, 1, 10, 100],
    # For determining how far the influence for each training point reaches
    # Using fixed values to stress test more complex vs. smoother boundaries
    'classifier__gamma': ['scale', 'auto', 0.001, 0.01, 0.1],
    # Using kernels to determine the best shape for the decision boundary
