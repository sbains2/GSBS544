...
headers = {"User-Agent": "Chrome (BAINS, S)"}
...
courses_list = soup.find_all("div", {"class": "courseblock"})
print('total courses found:', len(courses_list))
