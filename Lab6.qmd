...
print(comparing_coeffs, -gscv.best_score_) # 145836.197
...
print(comparing_coeffs, -gscv.best_score_) # 144690.1986
```
...
print(comparing_coeffs, -gscv.best_score_) # 145461.321

```

Report which combination of features and model performed best, based on the validation metric of MSE.
_The lasso model with the five best numeric variables and Division Interactions performed best in part 2, with a cross validation MSE of ~144,690. The elastic net regression model and the ridge regression model followed closely, at 145,461 and 145,836, respectively._
