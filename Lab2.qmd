...
regions = ['West', 'North', 'East', 'South', 'Northwest', 'Northeast', 'Southwest', 'Southeast', 'Midsouth', 'Great Lakes', 'Plains']
...
# Creating a mask for organic avocados in 2017 and regions
regions = ['West', 'North', 'East', 'South', 'Northwest', 'Northeast', 'Southwest', 'Southeast', 'Midsouth', 'Great Lakes', 'Plains', 'Total U.S.']
...
top_5 = volume_region[1:6].index.tolist()
...
formatted = prices.melt(id_vars=['geography', 'type'], var_name='size', value_name='avg_sales')

# Calculating total by geography and type
result = formatted.groupby(['geography', 'type'])['avg_sales'].sum().reset_index(name='sum')
...
formatted['proportion'] = formatted['avg_sales']/formatted['sum']
